...
<head>
  <meta charset="UTF-8" />
  <title>Lagerplan Halle 3-4654</title>
    ...
    <div class="col-12 col-lg-4 d-flex">
      <div class="card shadow-sm w-100 h-100">
        <div class="card-header d-flex align-items-center justify-content-between">
          <div>
            <div class="fw-semibold">Manuelle Einlagerung12345647987</div>
...
<div class="col-12 col-lg-4 d-flex">
  <div class="card h-100 shadow-sm w-100" id="lgFilterCard">
    ...
    <div class="col-12 col-lg-4 d-flex flex-column gap-3 h3-rightcol">
      ...
      <!-- Excel -->
      <div class="h3-panel flex-fill d-flex">
...
<div id="planViewport"
  ...
  <div id="planContent"
    ...
    <section id="w1-block-16-19" class="w1-block flex items-stretch gap-2 text-[10px] leading-tight">
    ...
    <div class="grid gap-2 text-xs">
      <div class="grid grid-cols-2 gap-2">
        ...
        <div>
          ...
          <input id="mmPlatz" type="number" min="1" max="120"
...
<script src="/Lagerplan/js/lg_filters.js?v=1"></script>
<script src="halle3.rows.layout.js" defer></script>
<script src="/Lagerplan/halle3.js?v=20260124_1"></script>

<script src="/Lagerplan/js/halle3.mobile.js?v=20260124_1"></script>
<script src="/Lagerplan/js/slot_flags.js?v=1"></script>

<!-- HALLE3_MARKER: 20260124-AAAA | FILE: <?= htmlspecialchars(__FILE__) ?> -->
